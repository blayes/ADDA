...
if (nobsid == 1) {
    ...
    partIds <- readRDS("/Shared/ssrivastva/dist_logistic/data/part_n_1.rds")
    ...
    partIds <- readRDS("/Shared/ssrivastva/dist_logistic/data/part_n_2.rds")
    ...
    partIds <- readRDS("/Shared/ssrivastva/dist_logistic/data/part_n_3.rds")
...
fname <- paste0("/Shared/ssrivastva/dist_logistic/result/sim/part/LT_sim_part_n_", nobsid, "_k_", nsubid, "_frac_", fid, "_rep_", cid, ".rds")
saveRDS(res, fname)
