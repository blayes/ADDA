...
if (nobsid == 1) {
    ...
    partIds <- readRDS("/Shared/ssrivastva/dist_lme/data/part_n_1.rds")
    ...
    subIdx <- split(1:ngroup, splitIdx)
    
    dataList <- list()
    for (ss in seq_along(subIdx)) {
        dataList[[ss]] <- list(x = fixefList0[subIdx[[ss]]],
                               z = ranefList0[subIdx[[ss]]],
                               y = ylist0[subIdx[[ss]]]                               
                               )
    }
    ...
    partIds <- readRDS("/Shared/ssrivastva/dist_lme/data/part_n_2.rds")
    ...
    partIds <- readRDS("/Shared/ssrivastva/dist_lme/data/part_n_3.rds")
...
fname <- paste0("/Shared/ssrivastva/dist_lme/result/sim/part/px_sim_part_n_", nobsid, "_k_", nsubid, "_frac_", fid, "_rep_", cid, ".rds")
saveRDS(res, fname)
